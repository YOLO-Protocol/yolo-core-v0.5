...
/**
 * @title   Script06B_DeployUnichainSepolia
 * @author  0xyolodev.eth
 * @dev     Deploy YOLO Protocol on Unichain Sepolia testnet
 */
contract Script06B_DeployUnichainSepolia is
    Script,
    ...
    Config02_AssetAndCollateralInitialization
{
    ...
    // Deployment log file
    string constant DEPLOYMENT_LOG = "logs/deployments/unichain-sepolia-deployment.json";

    function run() external {
        // A. Load environment variables
        uint256 deployerKey = vm.envUint("PRIVATE_KEY");
        address deployer = vm.addr(deployerKey);
        string memory rpcUrl = vm.envString("UNICHAIN_SEPOLIA_RPC");

        console.log("==========================================");
        console.log("    YOLO PROTOCOL DEPLOYMENT - UNICHAIN SEPOLIA");
        console.log("==========================================");
