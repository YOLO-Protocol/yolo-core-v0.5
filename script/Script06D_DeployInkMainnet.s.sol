...
/**
 * @title   Script06D_DeployInkMainnet
    ...
    Config02_AssetAndCollateralInitialization
{
    ...
    // Deployment log file
    string constant DEPLOYMENT_LOG = "logs/deployments/ink-mainnet-deployment.json";

    function run() external {
        // A. Load environment variables
        uint256 deployerKey = vm.envUint("PRIVATE_KEY");
        address deployer = vm.addr(deployerKey);
        string memory rpcUrl = vm.envString("INK_MAINNET_RPC");

        console.log("==========================================");
        console.log("    YOLO PROTOCOL DEPLOYMENT - INK MAINNET");
        console.log("==========================================");
