...
/**
 * @title   Script06A_DeployBaseSepolia
 * @author  0xyolodev.eth
 * @dev     Deploy YOLO Protocol on Base Sepolia testnet
 */
contract Script06A_DeployBaseSepolia is Script, Config01_OraclesAndAssets, Config02_AssetAndCollateralInitialization {
    ...
    // Deployment log file
    string constant DEPLOYMENT_LOG = "logs/deployments/base-sepolia-deployment.json";
    ...
    function run() external {
        ...
        console.log("==========================================");
        console.log("    YOLO PROTOCOL DEPLOYMENT - BASE SEPOLIA");
        console.log("==========================================");
